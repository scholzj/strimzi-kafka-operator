...
@JsonPropertyOrder({"brokerCertChainAndKey", "class", "externalTrafficPolicy", "loadBalancerSourceRanges", "bootstrap",
    ...
    "hostTemplate", "advertisedHostTemplate", "advertisedPortTemplate", "allocateLoadBalancerNodePorts", "parentRefs"})
...
public class GenericKafkaListenerConfiguration implements UnknownPropertyPreserving {
    ...
    @Description("Configures the template for generating the advertised ports of the individual brokers. " +
            ...
            "The only valid placeholder that you can use in the template is `{nodeId}`. " +
