...
tls="--tls.enabled --tls.ca-file=/etc/kafka-exporter/kafka-exporter-certs/cluster-ca.crt --tls.cert-file=/etc/kafka-exporter/kafka-exporter-certs/kafka-exporter.crt  --tls.key-file=/etc/kafka-exporter/kafka-exporter-certs/kafka-exporter.key"
