 ...
 */
public class DefaultTokenizedAdminClientProvider implements AdminClientProvider {
    /**
     * Constructor
     */
    public DefaultTokenizedAdminClientProvider() { }
    ...
    /* test */ Properties adminClientConfiguration(PemTrustSet kafkaCaTrustSet, PemAuthIdentity authIdentity, Properties config)    {
        ...
        String jaasConfig = String.format("org.apache.kafka.common.security.oauthbearer.OAuthBearerLoginModule required "
                        ...
                        + "%s=\"%s\" "
                        + "%s=\"%s\";",
                KubernetesServiceAccountTokenLoginCallbackHandler.NAMESPACE_OPTION, "myproject",
        ...
        config.setProperty("sasl.jaas.config", jaasConfig);
